export default {
  route: {
    ...
    'categoryList': '类目列表',
    'categoryCreate': '新建类目',
    'categoryStoryCreate': '新建类目故事',
    'categoryViewOrUpdate': '查看/编辑',
    'viewUpdateStory': '查看/编辑',
    'categoryStoryList': '类目故事列表',
    product: '商品管理',
    'productList': '商品列表',
    'createOrUpdate': '商品操作',
    'createProduct': '新增商品',
    ...
    'paymentList': '支付方式列表',
    'bankGatewayList': '支付宝网关',
    'createBankGateway': '编辑',
    'unionGatewayList': '银联网关支付',
    'createUnionGateway': '编辑',
    UserCenter: '个人中心',
    'ModifyInfo': '修改密码',
    logManage: '日志管理',
    'SystemLog': '系统日志',
