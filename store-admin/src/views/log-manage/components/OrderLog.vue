  ...
  <div class="app-container user-container">
    <el-card class="box-card box-card-content">
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column header-align="center" align="center" label="序号" type="index" width="60px" />
        <el-table-column header-align="center" align="center" show-overflow-tooltip prop="message" label="订单信息" width="150" />
        <el-table-column header-align="center" align="center" show-overflow-tooltip prop="context.message" label="报错信息" width="150" />
...
<script>
import { getOrderLog } from '@/api/log'
...
export default {
  ...
  methods: {
    ...
    getOrderLogList() {
      ...
      getOrderLog(this.listQuery).then(response => {
