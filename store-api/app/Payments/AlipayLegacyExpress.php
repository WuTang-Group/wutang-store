...
use App\Payments\AlipayLegacyExpress\AlipayCore;
...
class AlipayLegacyExpress
{
    ...
    public function buildRequestParaToString($para_temp)
    {
        ...
        return AlipayCore::createLinkStringUrlencode($para);
    }
    ...
    public function buildRequestForm($para_temp, $method, $button_name)
    {
        ...
        while (list ($key, $val) = custom_each($para)) {
    ...
    public function buildRequestHttp($para_temp)
    {
        ...
        //远程获取数据
        return AlipayCore::getHttpResponsePOST($this->alipay_gateway_new, $this->alipay_config['cacert'], $request_data, trim(strtolower($this->alipay_config['input_charset'])));
    }
    ...
    public function buildRequestHttpInFile($para_temp, $file_para_name, $file_name)
    {
        ...
        //远程获取数据
        return AlipayCore::getHttpResponsePOST($this->alipay_gateway_new, $this->alipay_config['cacert'], $para, trim(strtolower($this->alipay_config['input_charset'])));
    }
