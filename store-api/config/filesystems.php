    ...
    */
    ...
    'disks' => [
        ...
        'aliyun' => [
            'driver' => 'oss',
            'root' => '', // 设置上传时根前缀
            'access_key' => env('ALI_OSS_ACCESS_KEY_ID'),
            'secret_key' => env('ALI_OSS_ACCESS_KEY_SECRET'),
            'endpoint'   => env('ALI_OSS_ENDPOINT'), // 使用 ssl 这里设置如: https://oss-cn-beijing.aliyuncs.com
            'bucket'     => env('ALI_OSS_BUCKET'),
            'isCName'    => env('ALI_OSS_IS_CNAME', false), // 如果 isCname 为 false，endpoint 应配置 oss 提供的域名如：`oss-cn-beijing.aliyuncs.com`，否则为自定义域名，，cname 或 cdn 请自行到阿里 oss 后台配置并绑定 bucket
