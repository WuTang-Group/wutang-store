...
$factory->define(Product::class, function (Faker $faker) {
    return [
        ...
        'main_image' => \App\Handlers\RandomImageHandler::generateImage()->img_url,
        'main_image_2' => \App\Handlers\RandomImageHandler::generateImage()->img_url,
        'benefit_image' => \App\Handlers\RandomImageHandler::generateImage()->img_url,
