  ...
  $.fn.accordionjs = function(options) {
    ...
    */
    ...
    function setSizes(){
      ...
      $(".accordionjs > li").css("margin-left", "-"+sliderWidth+"px");      
      $(".accordionjs-content").css("width", contentWidth+"px");

      $(_selfId+"-styles").remove();
      $("head").append("<style id='"+_selfId+"-styles'>.accordionjs-select:checked ~ .accordionjs-separator { margin-left: "+sliderWidth+"px;}</style>");
      ...
      $(".accordionjs-title").css("height", "100%");
      $(".accordionjs-select").css("height", "100%");
      $(".accordionjs-content").css("height", "100%");
    }
    ...
    function _createHTMLForStep(node, step){
      ...
      $(node).append('<input type="radio" name="ac-tab" id="accordionjs'+step.number+'" value="'+step.number+'" class="accordionjs-select" '+selected+' ' + disabled + '/>');
      $(node).append('<div for="accordionjs'+step.number+'" class="accordionjs-title">' +
