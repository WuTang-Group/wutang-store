...
```bash
curl -X GET \
    -G "http://localhost/admin/alipay/legacy_express?page=numquam&page_limit=repudiandae" \
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"items":[{"pid":"fuga","key":"doloremque","seller_email":"enim"}]}'
...
```bash
curl -X PUT \
    "http://localhost/admin/alipay/legacy_express/1?id=voluptate" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/admin/alipay/legacy_express/1?id=nulla" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/admin/alipay/legacy_express/status/1?id=et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/admin/asset_img?page=et&page_limit=est" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"img":"sunt","img_location":"necessitatibus","type":"iure","product_id":"optio"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"img":"voluptatibus","img_location":"nulla","type":"itaque","product_id":"reprehenderit"}'
...
```bash
curl -X GET \
    -G "http://localhost/admin/category_stories?page=possimus&page_limit=accusantium" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/admin/category_stories?title=ea&title_en=nemo&description=maiores&description_en=deserunt&banner=quidem&product_category_id=natus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/admin/category_stories/1?title=eius&title_en=a&description=quia&description_en=iusto&banner=quis&product_category_id=esse" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/admin/logs/1?page=itaque&page_limit=iure" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/admin/order?page=blanditiis&page_limit=perspiciatis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/admin/order?page=non&page_limit=distinctio&username=ab&order_no=quibusdam&order_status=hic" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"refund_status":"fugiat","ship_status":"hic","status":"autem"}'
...
```bash
curl -X GET \
    -G "http://localhost/admin/product?page=rem&page_limit=illo" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/admin/product?product_category_id=magni&product_name=ad&product_name_en=aliquam&thumbnail=porro&slug=velit&short_description=quia&short_description_en=adipisci&price=quis&sale_price=aut&stock=et&seo_title=iure&seo_keyword=non&seo_description=voluptatem&benefit=dolor&benefit_en=ipsam&tech_description=illo&tech_description_en=voluptate&description=quaerat&description_en=id&usage=voluptatum&usage_en=quam&main_image=ab&main_image_2=consectetur&benefit_image=aut&product_video=sit&status=est&rating=dolores&sold_count=id&review_count=debitis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
let params = {
    "product_category_id": "magni",
    "product_name": "ad",
    "product_name_en": "aliquam",
    "thumbnail": "porro",
    "slug": "velit",
    "short_description": "quia",
    "short_description_en": "adipisci",
    "price": "quis",
    "sale_price": "aut",
    "stock": "et",
    "seo_title": "iure",
...
```bash
curl -X POST \
    "http://localhost/admin/product/1?product_category_id=ab&product_name=nam&product_name_en=vitae&thumbnail=aliquam&slug=eum&short_description=magni&short_description_en=laudantium&price=aut&sale_price=suscipit&stock=tempore&seo_title=non&seo_keyword=repellendus&seo_description=harum&benefit=qui&benefit_en=velit&tech_description=repudiandae&tech_description_en=amet&description=eveniet&description_en=ipsum&usage=perspiciatis&usage_en=pariatur&main_image=dolorem&main_image_2=quia&benefit_image=aut&product_video=eaque&status=laudantium&rating=beatae&sold_count=doloribus&review_count=ex" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
let params = {
    ...
    "product_name": "nam",
    "product_name_en": "vitae",
    "thumbnail": "aliquam",
    "slug": "eum",
    "short_description": "magni",
    "short_description_en": "laudantium",
    "price": "aut",
    "sale_price": "suscipit",
    "stock": "tempore",
    "seo_title": "non",
    "seo_keyword": "repellendus",
    "seo_description": "harum",
    "benefit": "qui",
    "benefit_en": "velit",
    "tech_description": "repudiandae",
    "tech_description_en": "amet",
    "description": "eveniet",
    "description_en": "ipsum",
    "usage": "perspiciatis",
    "usage_en": "pariatur",
    "main_image": "dolorem",
    "main_image_2": "quia",
...
```bash
curl -X GET \
    -G "http://localhost/admin/product_categories?page=eveniet&page_limit=alias" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/admin/product_categories?name=nihil&thumbnail=et&banner=omnis&title=laborum&title_en=temporibus&sub_title=rerum&describe=ut&describe_en=alias&describe_img=fuga&parent_id=quidem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/admin/product_categories/1?name=at&thumbnail=odio&banner=aut&title=rerum&title_en=omnis&sub_title=occaecati&describe=numquam&describe_en=praesentium&describe_img=repellendus&parent_id=deserunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
let params = {
    ...
    "sub_title": "occaecati",
    "describe": "numquam",
    "describe_en": "praesentium",
    "describe_img": "repellendus",
    "parent_id": "deserunt",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X POST \
    "http://localhost/admin/product_sku?title=cum&description=quisquam&price=aut&stock=nostrum&product_id=quia" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/admin/product_sku/1?title=consequatur&description=iure&price=optio&stock=harum&product_id=error" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/admin/the_houses?page=eum&page_limit=pariatur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"title":"et","sub_title":"aut","the_house_category_id":"veritatis","describe":"qui","banner":"molestias"}'
...
let body = {
    "title": "et",
    "sub_title": "aut",
    "the_house_category_id": "veritatis",
    "describe": "qui",
    "banner": "molestias"
}
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"title":"nesciunt","sub_title":"dolorem","the_house_category_id":"exercitationem","describe":"molestiae","banner":"at"}'
...
let body = {
    "title": "nesciunt",
    "sub_title": "dolorem",
    "the_house_category_id": "exercitationem",
    "describe": "molestiae",
    "banner": "at"
}
...
```bash
curl -X GET \
    -G "http://localhost/admin/the_house/category/list?page=dolor&page_limit=voluptas" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"et","banner":"et","title":"sed","sub_title":"blanditiis"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"quos","banner":"earum","title":"voluptate","sub_title":"aut"}'
...
```bash
curl -X GET \
    -G "http://localhost/admin/the_house_content/list?page=incidunt&page_limit=odit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"the_house_id":"quasi","title":"maxime","content":"quis","img":"placeat","img_desc":"nihil"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"the_house_id":"doloremque","title":"non","content":"culpa","img":"dolor","img_desc":"et"}'
...
```bash
curl -X GET \
    -G "http://localhost/admin/user?username=voluptatem&page=tempora&page_limit=omnis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/admin/user/1?name=voluptas&email=ut&phone=exercitationem&avatar=rerum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/admin/user/reset_password/1?oldPassword=odio&newPassword=qui&newPassword_confirmation=beatae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/admin/get_user?hash_id=ullam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/admin/user_addresses?province=ut&city=ea&district=ullam&address=qui&zip=molestiae&contact_name=architecto&contact_phone=eligendi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/admin/user_addresses/1?address_id=adipisci&province=ut&city=ut&district=accusamus&address=est&zip=dolores&contact_name=dolor&contact_phone=quia" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/admin/user_profiles/1?profile_id=culpa" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
        ...
        "the_house": [
            {
                ...
                "banner": "https:\/\/lorempixel.com\/640\/480\/?52338",
                "title": "ut ea temporibus",
                "sub_title": "dolorum qui deserunt",
                "describe": "Distinctio adipisci in ipsa aut suscipit exercitationem maxime impedit. Aliquam libero consectetur est rem exercitationem nulla. Ipsum iure pariatur et."
            },
            {
                "id": 41,
                "slug": "molestiae-pariatur",
                "the_house_category_id": 2,
                "banner": "https:\/\/lorempixel.com\/640\/480\/?74707",
                "title": "quas et cupiditate",
                "sub_title": "velit molestiae vel",
                "describe": "Atque qui sed autem perspiciatis consequatur nemo. Vitae perferendis eligendi reiciendis cum amet incidunt. Porro voluptas molestias fugiat repellat quia expedita consequatur est."
            },
            {
                "id": 13,
                "slug": "suscipit-dolores",
                "the_house_category_id": 3,
                "banner": "https:\/\/lorempixel.com\/640\/480\/?11972",
                "title": "laboriosam rerum dolores",
                "sub_title": "et aspernatur veritatis",
                "describe": "Libero possimus autem ullam est iusto animi velit. Aliquid ipsam voluptate quos assumenda et repellat quisquam. Fugit commodi rem et eligendi sapiente. Minima ipsa facilis dicta eos."
            }
        ]
    },
    "code": 20001,
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"excepturi","username":"facilis","password":"at","password_confirmation":"nemo","code":"dolor","captcha_key":"voluptatem","captcha_code":"cupiditate","password_question_id":9,"password_answer":"et"}'
...
```bash
curl -X GET \
    -G "http://localhost/api/user_question?username=ex" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/api/password_reset?username=qui&password_question_id=ad&password_answer=sint&password=at&password_confirmation=aperiam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
let params = {
    "username": "qui",
    "password_question_id": "ad",
    "password_answer": "sint",
    "password": "at",
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"oldPassword":"possimus","newPassword":"est","newPassword_confirmation":"aperiam"}'
...
let body = {
    ...
    "newPassword": "est",
    "newPassword_confirmation": "aperiam"
}
...
```bash
curl -X GET \
    -G "http://localhost/api/order_details/1?no=beatae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"address_id":"praesentium","remark":"est"}'
...
```bash
curl -X PUT \
    "http://localhost/api/orders/cancel?no=maxime" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/api/products/status/cum?page=quas&page_limit=exercitationem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/products/status/cum"
);
    ...
    "data": [
        {
            ...
            "product_name": "黑钻臻活眼部精华",
            "product_name_en": "quos ipsa animi",
            "thumbnail": "https:\/\/lorempixel.com\/640\/480\/?11654",
            "slug": "nam-aut",
            "short_description": "Nisi vitae distinctio a cupiditate ut.",
            "short_description_en": "Est soluta qui dolorem necessitatibus deleniti vel officiis. Harum facilis voluptatem veritatis voluptas quidem non. Aut culpa laborum eaque possimus est debitis. Atque nesciunt totam consequatur.",
            "price": "7079.00",
            "sale_price": "1.00",
            "stock": 79,
            "spec": null,
            "seo_title": "excepturi molestiae aut",
            "seo_keyword": "consequatur",
            "seo_description": "Nam voluptatem aut rerum ipsum.",
            "benefit": "Mollitia quasi sit quo odio. Libero ducimus est ut nostrum sed. Eum quam sed eligendi velit beatae ratione minus. Nobis autem itaque porro dolorem.",
            "benefit_en": "Ipsum sed et quo nam. Cupiditate quasi voluptas repellendus qui. Sapiente repellat et molestiae aperiam delectus aut.",
            "tech_description": "Magnam id cumque omnis. Sed vero magnam ullam nulla facilis nesciunt. Similique eos occaecati iure hic sunt et ab id.",
            "tech_description_en": "Illum voluptatem rem minus quibusdam vel magnam. Et modi ex illum provident. Animi ut reprehenderit sequi atque error sit.",
            "description": "Et magni et et laboriosam repellat autem quaerat voluptas. Fugiat et officiis consequatur ad eaque error. Sed dolorum incidunt voluptas voluptas ipsam inventore.",
            "description_en": "Qui dignissimos placeat quas asperiores natus similique. Alias enim nostrum quo.",
            "usage": "Nulla repudiandae dolor ut dolorem qui est maxime maxime. Est rerum doloremque itaque ipsum quae dolores aperiam. Atque beatae sed perspiciatis impedit fuga. Fugit dolore facilis dicta similique.",
            "usage_en": "Laborum quo consequatur natus aspernatur aut quod. Deserunt voluptate ut sint quia numquam reprehenderit blanditiis. Voluptates tenetur repellendus quae ipsa molestias repellendus quis. Alias eaque nesciunt velit minima explicabo sed.",
            "main_image": "https:\/\/lorempixel.com\/640\/480\/?99613",
            "main_image_2": "https:\/\/lorempixel.com\/640\/480\/?71400",
            "benefit_image": "https:\/\/lorempixel.com\/640\/480\/?19363",
            "product_video": null,
            "status": 1,
            "rating": 8.21,
            "sold_count": 9717,
            "review_count": 3893,
            "created_at": "2020-09-18 02:33:24",
            "updated_at": "2020-08-27 05:44:02"
        },
        {
            "id": 43,
            "product_category_id": 13,
            "product_name": "钻石冰莹面膜",
            "product_name_en": "dolores accusantium voluptates",
            "thumbnail": "https:\/\/lorempixel.com\/640\/480\/?60425",
            "slug": "possimus-voluptas",
            "short_description": "Quibusdam aut corrupti repellendus.",
            "short_description_en": "Quia est error iste amet at ut voluptatem. Facilis illum accusamus est eligendi vitae veniam. Commodi voluptas sequi consequatur pariatur molestias sit consectetur et. Dolore autem officia ut perferendis qui.",
            "price": "8943.00",
            "sale_price": "1.00",
            "stock": 567,
            "spec": null,
            "seo_title": "consequatur possimus et",
            "seo_keyword": "deleniti",
            "seo_description": "Id aut minima sed iste laborum.",
            "benefit": "Inventore similique distinctio nulla explicabo sint. Similique dolor qui aut ducimus earum laboriosam. Consectetur inventore nihil maiores eum eum placeat officia dolorem. Magnam non odio voluptatem qui autem.",
            "benefit_en": "Accusamus rerum quia sit culpa odit. Harum atque sed et officia et dolorem. Accusantium vero velit mollitia esse itaque nesciunt.",
            "tech_description": "Suscipit voluptatem dolorem dolorem ex quis sapiente. Repudiandae nulla quod iste nobis ipsum amet. Dolor qui laborum dolorum molestiae praesentium magnam.",
            "tech_description_en": "Eum laborum eaque est in dolor beatae excepturi. Esse unde nobis ad laboriosam minima nisi labore. Iste facilis est quod sint sequi aut impedit sit.",
            "description": "Facere id minima esse qui. Tempore magnam eligendi velit in nostrum ab. Amet labore a quis.",
            "description_en": "Repellat iusto veritatis vel assumenda est. Quaerat rerum saepe sit veniam. In veniam et aspernatur voluptatem nemo et.",
            "usage": "Consequatur aut numquam veritatis corporis nostrum. Suscipit necessitatibus velit rerum sit quae dolorem ducimus. Omnis in aut non culpa delectus ea ratione. Libero illo ipsum quas consequuntur quia aut.",
            "usage_en": "Quam labore pariatur et. Laudantium qui maiores beatae vitae quae.",
            "main_image": "https:\/\/lorempixel.com\/640\/480\/?98843",
            "main_image_2": "https:\/\/lorempixel.com\/640\/480\/?62226",
            "benefit_image": "https:\/\/lorempixel.com\/640\/480\/?60140",
            "product_video": null,
            "status": 1,
            "rating": 9.74,
            "sold_count": 6022,
            "review_count": 2322,
            "created_at": "2020-09-16 09:06:34",
            "updated_at": "2020-08-24 23:32:01"
        },
        {
            "id": 15,
            "product_category_id": 6,
...
```bash
curl -X GET \
    -G "http://localhost/api/product_category/story/facilis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/product_category/story/facilis"
);
...
```bash
curl -X GET \
    -G "http://localhost/api/product_category/explore/reiciendis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/product_category/explore/reiciendis"
);
...
```bash
curl -X PUT \
    "http://localhost/api/shop_carts/1?type=aperiam&product_id=sit&amount=consectetur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"province":"aut","city":"cumque","district":"aut","address":"consequatur","zip":18,"contact_name":"porro","contact_phone":18}'
...
```bash
curl -X PUT \
    "http://localhost/api/user_addresses/1?province=velit&city=incidunt&district=saepe&address=nisi&zip=quod&contact_name=atque&contact_phone=voluptates" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/api/user_profile?phone=commodi&real_name=veritatis&sex=autem&birthday=dolor&age=ab&province=illo&city=et&district=rerum&address=rerum&zip=accusamus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://localhost/api/wish_list?product_id=magni" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/api/wish_list?product_id=eos" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/alipay/bank_gateway/pay?no=libero&total_amount=et&payment_key=voluptatum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/alipay/aop_page/pay?no=corrupti&total_amount=qui&payment_key=quaerat" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/alipay/legacy_express/pay?no=dolorem&total_amount=veritatis&payment_key=vel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/unionpay/pay?no=est&total_amount=necessitatibus&payment_key=nulla" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/api/response_code?10001=unde&10003=odio&20001=eaque&40001=aliquam&40003=aut&40004=quibusdam&40005=illo&50001=non" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
