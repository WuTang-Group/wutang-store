...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/alipay/legacy_express?page=ea&page_limit=voluptatibus" \
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"items":[{"pid":"consequatur","key":"cupiditate","seller_email":"sit"}]}'
...
```bash
curl -X PUT \
    "http://store.wutang.com/admin/alipay/legacy_express/1?id=eum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://store.wutang.com/admin/alipay/legacy_express/status/1?id=omnis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/asset_img?page=nisi&page_limit=impedit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"img":"repudiandae","img_location":"quisquam","type":"esse","product_id":"aut"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"img":"voluptatem","img_location":"at","type":"necessitatibus","product_id":"vero"}'
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/category_stories?page=doloribus&page_limit=libero" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/category_stories?title=occaecati&title_en=maiores&description=deserunt&description_en=ut&banner=praesentium&product_category_id=consectetur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/category_stories/1?title=voluptatum&title_en=explicabo&description=repellat&description_en=occaecati&banner=sapiente&product_category_id=ipsum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/companies?page=suscipit&page_limit=natus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/company/departments/consequatur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://store.wutang.com/admin/company/departments/consequatur"
);
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/logs/1?page=doloremque&page_limit=qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://store.wutang.com/admin/logs/1?ids=excepturi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/order?page=et&page_limit=tempore" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/order?page=est&page_limit=aliquam&username=ut&order_no=laboriosam&order_status=dolorum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"refund_status":"consequatur","ship_status":"possimus","status":"velit"}'
...
let body = {
    "refund_status": "consequatur",
    "ship_status": "possimus",
    "status": "velit"
}
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/product?page=est&page_limit=rerum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/product?product_category_id=omnis&product_name=odio&product_name_en=ea&thumbnail=neque&slug=distinctio&short_description=ab&short_description_en=molestiae&price=quo&sale_price=sequi&stock=et&seo_title=earum&seo_keyword=et&seo_description=iste&benefit=culpa&benefit_en=ea&tech_description=ipsam&tech_description_en=quia&description=similique&description_en=vel&usage=officia&usage_en=ut&main_image=dicta&main_image_2=tenetur&benefit_image=qui&product_video=at&status=repellendus&rating=voluptatem&sold_count=veniam&review_count=odio" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
let params = {
    ...
    "seo_title": "earum",
    "seo_keyword": "et",
    "seo_description": "iste",
    "benefit": "culpa",
    "benefit_en": "ea",
    "tech_description": "ipsam",
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/product/1?product_category_id=corrupti&product_name=et&product_name_en=similique&thumbnail=vel&slug=molestiae&short_description=dolores&short_description_en=rerum&price=sint&sale_price=distinctio&stock=harum&seo_title=dicta&seo_keyword=architecto&seo_description=qui&benefit=eius&benefit_en=itaque&tech_description=ut&tech_description_en=magnam&description=qui&description_en=magni&usage=quos&usage_en=eos&main_image=deleniti&main_image_2=odio&benefit_image=autem&product_video=quod&status=occaecati&rating=fugiat&sold_count=sequi&review_count=autem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
let params = {
    ...
    "product_name": "et",
    "product_name_en": "similique",
    "thumbnail": "vel",
    "slug": "molestiae",
    "short_description": "dolores",
    "short_description_en": "rerum",
    "price": "sint",
    "sale_price": "distinctio",
    "stock": "harum",
    "seo_title": "dicta",
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/product_categories?page=et&page_limit=dolores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/product_categories?name=non&thumbnail=ab&banner=omnis&title=adipisci&title_en=et&sub_title=nihil&describe=ut&describe_en=natus&describe_img=dolores&parent_id=vitae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/product_categories/1?name=soluta&thumbnail=blanditiis&banner=eum&title=exercitationem&title_en=aliquid&sub_title=ea&describe=temporibus&describe_en=fugiat&describe_img=nam&parent_id=incidunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/product_sku?title=eos&description=ut&price=expedita&stock=suscipit&product_id=amet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/product_sku/1?title=vero&description=laudantium&price=expedita&stock=veniam&product_id=veritatis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/the_houses?page=asperiores&page_limit=enim" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"title":"deserunt","sub_title":"quia","the_house_category_id":"officiis","describe":"repellendus","banner":"natus"}'
...
let body = {
    "title": "deserunt",
    "sub_title": "quia",
    "the_house_category_id": "officiis",
    "describe": "repellendus",
    "banner": "natus"
}
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"title":"saepe","sub_title":"aspernatur","the_house_category_id":"harum","describe":"harum","banner":"tempora"}'
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/the_house/category/list?page=aut&page_limit=autem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"occaecati","banner":"quibusdam","title":"dolorum","sub_title":"neque"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"quo","banner":"magnam","title":"exercitationem","sub_title":"minima"}'
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/the_house_content/list?page=qui&page_limit=corrupti" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"the_house_id":"cumque","title":"ducimus","content":"quas","img":"provident","img_desc":"est"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"the_house_id":"voluptatem","title":"id","content":"quia","img":"alias","img_desc":"velit"}'
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/user?username=eum&page=inventore&page_limit=qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"username":"quia","password":"ut","name":"provident","role":"error","company":"aspernatur","department":"et","sex":13,"phone":13,"email":"molestias","member_code":"aut"}'
...
```bash
curl -X PUT \
    "http://store.wutang.com/admin/user/1?name=unde&email=architecto&phone=incidunt&avatar=vero" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://store.wutang.com/admin/user/reset_password/1?oldPassword=et&newPassword=sunt&newPassword_confirmation=deserunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
let params = {
    "oldPassword": "et",
    "newPassword": "sunt",
    "newPassword_confirmation": "deserunt",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://store.wutang.com/admin/get_user?hash_id=laboriosam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/admin/user_addresses?province=quia&city=recusandae&district=adipisci&address=fugit&zip=praesentium&contact_name=blanditiis&contact_phone=hic" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://store.wutang.com/admin/user_addresses/1?address_id=eaque&province=aut&city=nostrum&district=aut&address=est&zip=quaerat&contact_name=veniam&contact_phone=ipsa" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://store.wutang.com/admin/user_addresses/1?address_id=esse" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://store.wutang.com/admin/user_profiles/1?profile_id=nisi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"numquam","username":"quod","password":"qui","password_confirmation":"cumque","code":"iure","captcha_key":"ut","captcha_code":"sed","password_question_id":16,"password_answer":"in"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"username":"in","password":"incidunt"}'
...
```bash
curl -X PUT \
    "http://store.wutang.com/api/password_reset?username=qui&password_question_id=nobis&password_answer=et&password=fuga&password_confirmation=tempore" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"oldPassword":"aut","newPassword":"delectus","newPassword_confirmation":"voluptas"}'
...
let body = {
    "oldPassword": "aut",
    "newPassword": "delectus",
    "newPassword_confirmation": "voluptas"
}
...
```bash
curl -X GET \
    -G "http://store.wutang.com/api/orders?page=similique&page_limit=dicta" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"address_id":"suscipit","remark":"itaque"}'
...
```bash
curl -X GET \
    -G "http://store.wutang.com/api/products/status/quod?page=tempora&page_limit=laudantium" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://store.wutang.com/api/products/status/quod"
);

let params = {
    "page": "tempora",
    "page_limit": "laudantium",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://store.wutang.com/api/product_category/story/repellendus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://store.wutang.com/api/product_category/story/repellendus"
);
...
```bash
curl -X PUT \
    "http://store.wutang.com/api/shop_carts/1?type=molestiae&product_id=in&amount=libero" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"province":"explicabo","city":"rerum","district":"voluptatem","address":"eveniet","zip":8,"contact_name":"qui","contact_phone":6}'
...
```bash
curl -X PUT \
    "http://store.wutang.com/api/user_addresses/1?province=tenetur&city=cumque&district=aliquid&address=sint&zip=tempora&contact_name=voluptates&contact_phone=et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://store.wutang.com/api/user_profile?phone=aut&real_name=deserunt&sex=sed&birthday=officia&age=et&province=excepturi&city=sed&district=similique&address=dolore&zip=optio" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://store.wutang.com/api/wish_list?product_id=expedita" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/alipay/bank_gateway/pay?no=porro&total_amount=qui&payment_key=voluptatem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/alipay/aop_page/pay?no=aperiam&total_amount=vero&payment_key=nemo" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/alipay/legacy_express/pay?no=esse&total_amount=voluptates&payment_key=accusantium" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/unionpay/pay?no=sapiente&total_amount=aspernatur&payment_key=vel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://store.wutang.com/api/response_code?10001=alias&10003=neque&20001=qui&40001=tempore&40003=voluptatibus&40004=explicabo&40005=ullam&50001=et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
