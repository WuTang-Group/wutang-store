			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-8">
					<div class="checkout">
						<div class="accordion">
			              	...
			              	<h2 class="text-white title mb-0 collapsed" data-toggle="collapse" data-target="#payment-method" aria-expanded="true" aria-controls="payment-method">@lang('general.payment')</h2>
				...
				<div class="col-lg-4">
					<div class="order-review pt-5 scroll-element">
		                ...
		                <div>
		                	<button type="submit" class="btn btn-outline w-100 mt-3">@lang('general.buy-now')</button>
		                </div>
...
<script type="text/javascript">
	...
	function refresh_addresses() {
	    ...
	    axios.get('http://localhost:8000/refresh_addresses')
	        .then(function (response) {
