        ...
        <div class="row privacy-policy-wrapper justify-content-center">
          <div class="col-12 col-md-9 col-lg-8" id="privacy-policy">
            ...
            <div class="accordion">
              ...
              <h2 class="text-white title mb-0 collapsed">
                知识产权
              </h2>
              ...
              <h2 class="text-white title border-bottom-0 mt-5 mb-0 no-toggle">
                特定版块规定
              </h2>
              <p>本网站有不同的内容版块：<br>
          ...
          <div class="col-12 col-md-9 col-lg-8" id="website">
            <h2 class="text-white title">网站信息</h2>
            <div class="accordion">
              <h2 class="text-white title mb-0 collapsed">
                通用信息
              </h2>
          ...
          <div class="col-12 col-md-9 col-lg-8" id="cookie">
            <h2 class="text-white title">Cookies政策</h2>
