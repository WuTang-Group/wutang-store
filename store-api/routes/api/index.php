...
Route::middleware('throttle:' . config('api.rate_limits.access'))->group(function () {
    ...
    Route::middleware('auth:api')->group(function () {
        ...
        // 修改密码
        Route::put('user/password/{username}', 'UserController@resetPassword')->name('user.resetPassword');
        // 获取单个用户信息
        ...
        Route::post('product_categories/edit/{productCategoriesId}', 'ProductCategoryController@edit')->name('product_categories');
        Route::delete('product_categories', 'ProductCategoryController@destroy')->name('product_categories.destroy');
    });
